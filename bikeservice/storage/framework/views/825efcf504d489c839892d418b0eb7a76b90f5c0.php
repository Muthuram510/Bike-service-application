                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('blog.update', $blog->id)); ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="model" class="form-control" value="<?php echo e($blog->model); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="body" id="" cols="30" rows="10" class="form-control"><?php echo e($blog->body); ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="date" class="form-control" value="<?php echo e(date('Y-m-d', strtotime($blog->date))); ?>">
                            </div>
